...
const individual_submission_columnInfo = {
    ...
    ASR_LM_wer_hidden_dev: {
        header: "ASR-LM hidden dev",
        width: 110,
        higherBetter: true,
        isScore: true,
        type: "number",
    ...
    ASR_wer_hidden_test: {
        header: "ASR hidden test",
        width: 110,
        higherBetter: true,
        isScore: true,
        type: "number",
    },
    ASR_LM_wer_hidden_test: {
        header: "ASR-LM hidden test",
        width: 110,
        higherBetter: true,
        isScore: true,
        type: "number",
    },
    QbE_mtwv_hidden_test: {
        header: "QbE hidden test",
        width: 110,
        higherBetter: true,
        isScore: true,
        type: "number",
